        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="<?= base_url('/product/create') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-0 mt-2">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line" placeholder="Product Name" name="product_name" value="<?= set_value('product_name') ?>">
                                </div>
                            ...
                            <div class="form-group mb-0 mt-2">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line" placeholder="Original Price" name="MRP" value="<?= set_value('MRP') ?>">
                                </div>
                            ...
                            <div class="form-group mb-0 mt-2">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control ps-0 form-control-line" placeholder="Selling Price" name="selling_price" value="<?= set_value('selling_price') ?>">
                                </div>
                            ...
                            <div class="form-group mb-0 mt-2">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control ps-0 form-control-line" placeholder="Product Quantity" name="qty" value="<?= set_value('qty') ?>">
                                </div>
                            ...
                            <div class="input-group px-2 mt-2">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="inputGroupFile01" name="product_image" value="<?= set_value('product_image') ?>">
