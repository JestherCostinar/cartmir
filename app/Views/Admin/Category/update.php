            ...
            <div class="col-xl-12 col-md-12 col-12 dasbord_subbox">
                ...
                <div class="right_box">
                    <div class="products_box">
                        ...
                        <form class="login_form" action="<?= base_url('/category/update/' . $category['id']) ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group mt-4">
                                <label>Category Name <span class="text-danger"> *</span></label>
                                <input type="text" placeholder="Category Name" name="category_name" class="form-control" value="<?= set_value('category_name', $category['category_name']) ?>">
